 ...
 * Generated for Laravel 7.12.0 on 2020-06-09 07:21:21.
 *
...
namespace  {
    ...
    class Form extends \Collective\Html\FormFacade {
        public static function group_open(string $string)
        {
        }
        ...
        public static function btn_group_open($options = [])
        {
        }

        public static function btn_group_close()
        {
        }

        public static function btn_group_btn(string $type, string $name, int $value, ?string $btnLabelValue, bool $btnLabelIcon, string $btnLabelIconClass, array $inputOptions, array $btnOptions)
        {
        }

        public static function published_at(string $model, array $inputOptionsTrue, array $inputOptionsFalse)
        {
        }

        public static function input_full(string $string, string $string1, string $string2, $param)
        {
        }
    }
